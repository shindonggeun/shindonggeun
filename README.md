...
* 💻 (주)훈훈소프트 웹 개발팀 인턴 근무: 이커머스 시스템 개발 및 운영 → node.js 및 Vue.js를 통한 웹 프로그래밍 관련 업무(프론트엔드 & 백엔드) (2019.09.02 ~ 2020.01.07)
* 🎓 연세대학교 미래캠퍼스 컴퓨터정보통신공학부 정보통신공학과 졸업 (2020.03 ~ 2022.02)
* 💻 연세대학교 미래캠퍼스 디지털통신연구실 학부연구생 (2020.08 ~ 2021.06)
* 💻 한국인식산업 연구소 개발팀 인턴 실습생 근무: 응용 SW 개발 → 안면인식 솔루션 테스트 및 openCV와 딥러닝 프로그래밍 업무 (2021.06.28 ~ 2021.08.20)
* 💻 MSA 기반 Full Stack 개발자 양성과정 수료 [한국소프트웨어산업협회 (KOSA)] (2022.02.17 ~ 2022.07.15)
* 💻 현대IT&E 운영사업부문 그린푸드 IT팀 근무: 유통 / 외식 (영업) → 그린푸드 ERP 프로그램(H-WIS) 운영 및 개발 업무, 데이터 추출 업무, 쿼리 튜닝 업무 (2021.06.28 ~ 2021.08.20)
